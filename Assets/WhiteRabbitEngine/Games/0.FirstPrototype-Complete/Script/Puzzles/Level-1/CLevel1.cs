...
public class CLevel1 : CLevelGeneric
{
  ...
  private void ResetSequence()
  {
        ...
        { 
            var ObjectsPuzzles = FindObjectsByType<CInteractiveObject>(FindObjectsSortMode.None);
            var LightPuzzle = FindFirstObjectByType<CLightSwitch>();
   ...
   private void SuccesfullSequence()
   {
    ...
    {
        var ObjectsPuzzles = FindFirstObjectByType<CLightSwitch>();
        if (isSuccesfull == true)
        {
